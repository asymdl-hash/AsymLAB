                                        ...
                                        <div className="rounded-lg border border-amber-200/60 bg-amber-50/30 p-3 space-y-2.5">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3" style={{ display: expandEscalaCor ? undefined : 'none' }}>
                                                ...
                                                <div className="grid grid-cols-2 gap-2">
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between"><label className="text-xs font-medium text-gray-500 uppercase tracking-wider">Fotos</label><button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, escalaCor: [...(prev.escalaCor || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors" title="Criar nota">📝</button></div>
                                                        ...
                                                        {(fieldNotes.escalaCor || []).map((note, ni) => (<div key={ni} className="flex items-center gap-0.5 mt-0.5"><input type="text" placeholder="Nota do campo..." value={note} onChange={e => { const val = e.target.value; setFieldNotes(prev => { const arr = [...(prev.escalaCor || [])]; arr[ni] = val; return { ...prev, escalaCor: arr }; }); }} className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300" /><button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev.escalaCor || [])]; arr.splice(ni, 1); return { ...prev, escalaCor: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button></div>))}
                                                    </div>
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between"><label className="text-xs font-medium text-gray-500 uppercase tracking-wider">Polarizadas</label><button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, polarizada: [...(prev.polarizada || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors" title="Criar nota">📝</button></div>
                                                        ...
                                                        {(fieldNotes.polarizada || []).map((note, ni) => (<div key={ni} className="flex items-center gap-0.5 mt-0.5"><input type="text" placeholder="Nota do campo..." value={note} onChange={e => { const val = e.target.value; setFieldNotes(prev => { const arr = [...(prev.polarizada || [])]; arr[ni] = val; return { ...prev, polarizada: arr }; }); }} className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300" /><button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev.polarizada || [])]; arr.splice(ni, 1); return { ...prev, polarizada: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button></div>))}
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            return faceFields.map(({ label, state, setter, ref, key, guideImages }) => (
                                                                ...
                                                                >
                                                                    <div className="flex items-center justify-between mb-1">
                                                                        <span className="text-[8px] font-semibold text-gray-500">{label}</span>
                                                                        <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, [`face_${key}`]: [...(prev[`face_${key}`] || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors flex items-center gap-0.5" title="Criar nota para este campo">📝</button>
                                                                    </div>
                                                                    ...
                                                                    {(fieldNotes[`face_${key}`] || []).map((note, ni) => (
                                                                        <div key={ni} className="flex items-center gap-0.5 mt-0.5">
                                                                            <input
                                                                                type="text"
                                                                                ...
                                                                                className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300"
                                                                            />
                                                                            <button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev[`face_${key}`] || [])]; arr.splice(ni, 1); return { ...prev, [`face_${key}`]: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button>
                                                                        </div>
                                                                    ))}
                                                                    <input
                                                                        ref={ref}
                                                        ...
                                                        {(() => {
                                                            ...
                                                            return closeupFields.map(({ label, state, setter, ref, key, guideImages }) => (
                                                                ...
                                                                >
                                                                    <div className="flex items-center justify-between mb-1">
                                                                        <span className="text-[8px] font-semibold text-gray-500">{label}</span>
                                                                        <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, [`closeup_${key}`]: [...(prev[`closeup_${key}`] || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors flex items-center gap-0.5" title="Criar nota para este campo">📝</button>
                                                                    </div>
                                                                    ...
                                                                    {(fieldNotes[`closeup_${key}`] || []).map((note, ni) => (
                                                                        <div key={ni} className="flex items-center gap-0.5 mt-0.5">
                                                                            <input type="text" placeholder="Nota do campo..." value={note} onChange={e => { const val = e.target.value; setFieldNotes(prev => { const arr = [...(prev[`closeup_${key}`] || [])]; arr[ni] = val; return { ...prev, [`closeup_${key}`]: arr }; }); }} className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300" />
                                                                            <button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev[`closeup_${key}`] || [])]; arr.splice(ni, 1); return { ...prev, [`closeup_${key}`]: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button>
                                                                        </div>
                                                                    ))}
                                                ...
                                                <div className={cn('grid grid-cols-1 gap-2', photoSetup === 'basic' ? 'sm:grid-cols-1' : 'sm:grid-cols-4')}>
                                                    ...
                                                    {photoSetup === 'complete' && (<fieldset className="border border-gray-200 rounded-lg p-2 sm:col-span-2">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2">
                                                            ...
                                                            >
                                                                <div className="flex items-center justify-between mb-1"><span className="text-[8px] font-semibold text-gray-500">Intraoral Superior</span><button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, intraoralSup: [...(prev.intraoralSup || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors" title="Criar nota">📝</button></div>
                                                                ...
                                                                {(fieldNotes.intraoralSup || []).map((note, ni) => (<div key={ni} className="flex items-center gap-0.5 mt-0.5"><input type="text" placeholder="Nota do campo..." value={note} onChange={e => { const val = e.target.value; setFieldNotes(prev => { const arr = [...(prev.intraoralSup || [])]; arr[ni] = val; return { ...prev, intraoralSup: arr }; }); }} className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300" /><button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev.intraoralSup || [])]; arr.splice(ni, 1); return { ...prev, intraoralSup: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button></div>))}
                                                            </div>
                                                            ...
                                                            >
                                                                <div className="flex items-center justify-between mb-1"><span className="text-[8px] font-semibold text-gray-500">Intraoral Inferior</span><button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, intraoralInf: [...(prev.intraoralInf || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors" title="Criar nota">📝</button></div>
                                                                ...
                                                                {(fieldNotes.intraoralInf || []).map((note, ni) => (<div key={ni} className="flex items-center gap-0.5 mt-0.5"><input type="text" placeholder="Nota do campo..." value={note} onChange={e => { const val = e.target.value; setFieldNotes(prev => { const arr = [...(prev.intraoralInf || [])]; arr[ni] = val; return { ...prev, intraoralInf: arr }; }); }} className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300" /><button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev.intraoralInf || [])]; arr.splice(ni, 1); return { ...prev, intraoralInf: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button></div>))}
                                                            </div>
                                                        </div>
                                                    </fieldset>)}
                                                    ...
                                                    {photoSetup === 'complete' && (<fieldset className="border border-gray-200 rounded-lg p-2">
                                                        ...
                                                        >
                                                            <div className="flex items-center justify-between mb-1"><span className="text-[8px] font-semibold text-gray-500">45º</span><button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, foto45: [...(prev.foto45 || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors" title="Criar nota">📝</button></div>
                                                            ...
                                                            {(fieldNotes.foto45 || []).map((note, ni) => (<div key={ni} className="flex items-center gap-0.5 mt-0.5"><input type="text" placeholder="Nota do campo..." value={note} onChange={e => { const val = e.target.value; setFieldNotes(prev => { const arr = [...(prev.foto45 || [])]; arr[ni] = val; return { ...prev, foto45: arr }; }); }} className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300" /><button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev.foto45 || [])]; arr.splice(ni, 1); return { ...prev, foto45: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button></div>))}
                                                        </div>
                                                    </fieldset>)}
                                                    ...
                                                    <fieldset className="border border-gray-200 rounded-lg p-2">
                                                        ...
                                                        >
                                                            <div className="flex items-center justify-between mb-1"><span className="text-[8px] font-semibold text-gray-500">Outros</span><button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, outros: [...(prev.outros || []), ''] }))} className="text-[7px] text-gray-400 hover:text-amber-500 transition-colors" title="Criar nota">📝</button></div>
                                                            ...
                                                            {(fieldNotes.outros || []).map((note, ni) => (<div key={ni} className="flex items-center gap-0.5 mt-0.5"><input type="text" placeholder="Nota do campo..." value={note} onChange={e => { const val = e.target.value; setFieldNotes(prev => { const arr = [...(prev.outros || [])]; arr[ni] = val; return { ...prev, outros: arr }; }); }} className="flex-1 px-1 py-0.5 text-[7px] text-gray-600 bg-amber-50/50 border border-amber-200 rounded focus:outline-none focus:border-amber-400 placeholder:text-gray-300" /><button type="button" onClick={() => setFieldNotes(prev => { const arr = [...(prev.outros || [])]; arr.splice(ni, 1); return { ...prev, outros: arr }; })} className="text-[8px] text-gray-300 hover:text-red-400">✕</button></div>))}
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
