                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3" style={{ display: expandEscalaCor ? undefined : 'none' }}>
                                                ...
                                                <div className="grid grid-cols-2 gap-2">
                                                    ...
                                                    >
                                                        ...
                                                        <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, escalaCor: [...(prev.escalaCor || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                    </div>
                                                    ...
                                                    >
                                                        ...
                                                        <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, polarizada: [...(prev.polarizada || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        {(() => {
                                                            ...
                                                            return faceFields.map(({ label, state, setter, ref, key, guideImages }) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, [`face_${key}`]: [...(prev[`face_${key}`] || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                                    <input
                                                                        ref={ref}
                                                                        type="file"
                                                                        accept="image/*"
                                                        ...
                                                        {(() => {
                                                            ...
                                                            return closeupFields.map(({ label, state, setter, ref, key, guideImages }) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, [`closeup_${key}`]: [...(prev[`closeup_${key}`] || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                ...
                                                <div className={cn('grid grid-cols-1 gap-2', photoSetup === 'basic' ? 'sm:grid-cols-1' : 'sm:grid-cols-4')}>
                                                    ...
                                                    {photoSetup === 'complete' && (<fieldset className="border border-gray-200 rounded-lg p-2 sm:col-span-2">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2">
                                                            ...
                                                            >
                                                                ...
                                                                <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, intraoralSup: [...(prev.intraoralSup || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                            </div>
                                                            ...
                                                            >
                                                                ...
                                                                <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, intraoralInf: [...(prev.intraoralInf || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                            </div>
                                                        </div>
                                                    </fieldset>)}
                                                    ...
                                                    {photoSetup === 'complete' && (<fieldset className="border border-gray-200 rounded-lg p-2">
                                                        ...
                                                        >
                                                            ...
                                                            <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, foto45: [...(prev.foto45 || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                        </div>
                                                    </fieldset>)}
                                                    ...
                                                    <fieldset className="border border-gray-200 rounded-lg p-2">
                                                        ...
                                                        >
                                                            ...
                                                            <button type="button" onClick={() => setFieldNotes(prev => ({ ...prev, outros: [...(prev.outros || []), ''] }))} className="w-full mt-1 py-1 text-[9px] text-gray-400 hover:text-amber-500 hover:bg-amber-50/50 rounded border border-dashed border-gray-200 hover:border-amber-300 transition-colors flex items-center justify-center gap-0.5">📝 + Nota</button>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
