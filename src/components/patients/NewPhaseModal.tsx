        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4"
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    <h2 className="text-lg font-bold text-gray-900">Nova Fase</h2>
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    <div>
                        ...
                        <input type="text" value={nome} onChange={(e) => setNome(e.target.value)}
                            ...
                            className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50" />
                    </div>
