        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4"
            ...
            <div className="bg-muted border border-border rounded-xl shadow-2xl w-full max-w-md">
                ...
                <div className="flex items-center justify-between p-4 border-b border-border">
                    <h2 className="text-lg font-bold text-card-foreground">Nova Fase</h2>
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    <div>
                        ...
                        <input type="text" value={nome} onChange={(e) => setNome(e.target.value)}
                            ...
                            className="w-full bg-muted border border-gray-600 rounded-lg px-3 py-2 text-sm text-card-foreground placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50" />
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-card-foreground/80 mb-1">Ordem</label>
                        <input type="text" readOnly value={`Fase ${currentPhaseCount + 1}`}
                            className="w-full bg-muted/50 border border-gray-600 rounded-lg px-3 py-2 text-sm text-muted-foreground cursor-not-allowed" />
                    </div>
