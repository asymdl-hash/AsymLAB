                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    <div>
                        ...
                        <input type="text" value={nome} onChange={(e) => setNome(e.target.value)}
                            ...
                            className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50" />
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-foreground/80 mb-1">Ordem</label>
                        <input type="text" readOnly value={`Fase ${currentPhaseCount + 1}`}
                            className="w-full bg-gray-700/50 border border-gray-600 rounded-lg px-3 py-2 text-sm text-muted-foreground cursor-not-allowed" />
                    </div>
