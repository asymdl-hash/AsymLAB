        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="bg-gray-800 border border-gray-700 rounded-2xl w-full max-w-lg mx-4 shadow-2xl">
                ...
                <div className="p-4 space-y-4 max-h-[70vh] overflow-y-auto">
                    {/* Plano */}
                    <div>
                        <label className="text-xs text-gray-400 font-medium mb-1 block">Plano</label>
                        <select
                    ...
                    {selectedPlanId && phases.length > 0 && (
                        <div>
                            <label className="text-xs text-gray-400 font-medium mb-1 block">Fase</label>
                            <select
                    ...
                    {/* Valor */}
                    <div>
                        <label className="text-xs text-gray-400 font-medium mb-1 block">Valor (€) *</label>
                        <input
                            type="number"
                            step="0.01"
                            min="0"
                    ...
                    {/* PDF Upload */}
                    <div>
                        <label className="text-xs text-gray-400 font-medium mb-1 block">PDF da Factura</label>
                        {pdfFile ? (
