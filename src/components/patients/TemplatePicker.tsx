        ...
        <div className="space-y-3">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-700 placeholder:text-gray-400 focus:outline-none focus:border-gray-400"
                />
            </div>
            ...
            {template.fields && template.fields.length > 0 && (
                <div className="mt-1.5 flex flex-wrap gap-1.5">
                    ...
                    {template.fields.length > 5 && (
                        <span className="text-[10px] text-gray-400">+{template.fields.length - 5}</span>
                    )}
                </div>
            )}
        </button>
