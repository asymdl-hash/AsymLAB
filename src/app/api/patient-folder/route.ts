...
const PLAN_SUBFOLDERS = [
    ...
    'Info Plano/Escala de Cor/Escala',
    'Info Plano/Escala de Cor/Polarizada',
    'Info Plano/Retrato',
    'Info Plano/Retrato/Repouso',
    'Info Plano/Retrato/Sorriso Natural',
    'Info Plano/Retrato/Sorriso Máximo',
    'Info Plano/Retrato/45º',
    'Info Plano/Retrato/Perfil',
    'Info Plano/Close-up',
    'Info Plano/Close-up/Repouso',
    'Info Plano/Close-up/Sorriso Natural',
    'Info Plano/Close-up/Sorriso Máximo',
    'Info Plano/Close-up/Retractores Frontal',
    'Info Plano/Close-up/Retractores 45º',
    'Info Plano/Vista Oclusal',
    'Info Plano/Vista Oclusal/Intraoral Superior',
    'Info Plano/Vista Oclusal/Intraoral Inferior',
    'Info Plano/45º',
