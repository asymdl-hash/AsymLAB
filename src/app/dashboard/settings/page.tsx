            ...
            <div className="flex h-full w-full bg-background overflow-hidden">
                ...
                <div className="w-64 flex-shrink-0 border-r border-border bg-card h-full overflow-y-auto">
                    <div className="p-6 border-b border-border">
                        <h1 className="text-lg font-bold text-card-foreground flex items-center gap-2">
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    <div className="bg-card border-b border-border px-8 py-6">
                        <h2 className="text-xl font-semibold text-card-foreground">{activeTabConfig?.label}</h2>
